    ...
    <Box py={8} backgroundColor="#2350b2">
      <Container>
        ...
        >
          ...
          <StatCard label={released} number={156} gridColumn="3/5" />
          <StatCard label={detention} number={262} gridColumn="1/3" />
          <StatCard label={toVerify} number={235} gridColumn="3/5" />
          <StatCard label={total} number={691} gridColumn="1/5" />
        </Grid>
      </Container>
    </Box>
  );
